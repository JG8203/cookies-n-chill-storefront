...
function ProductCard({ productPreview, cheapestPrice }: { productPreview: ProductPreviewType, cheapestPrice: any }) {
  return (
    <LocalizedClientLink
    ...
    >
      <div className="w-72 bg-white shadow rounded" data-testid="product-wrapper">
        ...
        <div className="p-4 flex flex-col items-center">
          <h1 className="text-gray-800 text-center mt-1" data-testid="product-title">{productPreview.title}</h1>
          <p className="text-center text-gray-800 mt-1">{cheapestPrice && <PreviewPrice price={cheapestPrice} />}</p>

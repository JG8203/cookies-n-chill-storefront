const ProductActions = () => (
    <div className="w-full">
      <div className="flex justify-center items-center mt-2">
        ...
        <button className="bg-white rounded-r border text-gray-600 hover:bg-gray-100 active:bg-gray-200 disabled:opacity-50 inline-flex items-center px-2 py-1 border-l border-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
